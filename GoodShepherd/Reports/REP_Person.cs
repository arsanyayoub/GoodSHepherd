...
namespace GoodShepherd.Reports {
    ...
    public class REP_Person : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GoodShepherd.Reports.REP_Person.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedREP_Person : Component, ICachedReport {
        
        public CachedREP_Person() {
        }
